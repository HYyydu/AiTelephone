...
// Vendor-specific color mappings
const getVendorColor = (vendor: string): string => {
  ...
  if (
    vendorLower.includes("whole foods") ||
    vendorLower.includes("wholefoods")
  ) {
    return "bg-gradient-to-br from-green-500 to-green-600";
  }
  if (vendorLower.includes("spectrum") || vendorLower.includes("chase")) {
    return "bg-gradient-to-br from-blue-500 to-blue-600";
  }
  if (vendorLower.includes("walmart") || vendorLower.includes("target")) {
    return "bg-gradient-to-br from-red-500 to-red-600";
  }
  if (vendorLower.includes("verizon") || vendorLower.includes("at&t")) {
      ...
      <CardHeader className="pb-0">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div
              className={`w-10 h-10 ${getVendorColor(
                task.vendor
